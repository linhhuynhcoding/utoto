...
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(1,'Đông Bắc Bộ','Northeast','dong_bac_bo','northest') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(2,'Tây Bắc Bộ','Northwest','tay_bac_bo','northwest') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(3,'Đồng bằng sông Hồng','Red River Delta','dong_bang_song_hong','red_river_delta') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(4,'Bắc Trung Bộ','North Central Coast','bac_trung_bo','north_central_coast') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(5,'Duyên hải Nam Trung Bộ','South Central Coast','duyen_hai_nam_trung_bo','south_central_coast') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(6,'Tây Nguyên','Central Highlands','tay_nguyen','central_highlands') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(7,'Đông Nam Bộ','Southeast','dong_nam_bo','southeast') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_regions(id,name,name_en,code_name,code_name_en) VALUES(8,'Đồng bằng sông Cửu Long','Mekong River Delta','dong_bang_song_cuu_long','southwest') ON CONFLICT (id) DO NOTHING;
------------------------------------

-- DATA for administrative_units --
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(1,'Thành phố trực thuộc trung ương','Municipality','Thành phố','City','thanh_pho_truc_thuoc_trung_uong','municipality') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(2,'Tỉnh','Province','Tỉnh','Province','tinh','province') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(3,'Thành phố thuộc thành phố trực thuộc trung ương','Municipal city','Thành phố','City','thanh_pho_thuoc_thanh_pho_truc_thuoc_trung_uong','municipal_city') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(4,'Thành phố thuộc tỉnh','Provincial city','Thành phố','City','thanh_pho_thuoc_tinh','provincial_city') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(5,'Quận','Urban district','Quận','District','quan','urban_district') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(6,'Thị xã','District-level town','Thị xã','Town','thi_xa','district_level_town') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(7,'Huyện','District','Huyện','District','huyen','district') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(8,'Phường','Ward','Phường','Ward','phuong','ward') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(9,'Thị trấn','Commune-level town','Thị trấn','Township','thi_tran','commune_level_town') ON CONFLICT (id) DO NOTHING;
INSERT INTO administrative_units(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(10,'Xã','Commune','Xã','Commune','xa','commune') ON CONFLICT (id) DO NOTHING;
------------------------------------
...
('79','Hồ Chí Minh','Ho Chi Minh','Thành phố Hồ Chí Minh','Ho Chi Minh City','ho_chi_minh',1,7) ON CONFLICT (code) DO NOTHING;
...
('96','Cà Mau','Ca Mau','Tỉnh Cà Mau','Ca Mau Province','ca_mau',2,8) ON CONFLICT (code) DO NOTHING;
...
('052','Nguyên Bình','Nguyen Binh','Huyện Nguyên Bình','Nguyen Binh District','nguyen_binh','04',7) ON CONFLICT (code) DO NOTHING;
...
('123','Mộc Châu','Moc Chau','Huyện Mộc Châu','Moc Chau District','moc_chau','14',7) ON CONFLICT (code) DO NOTHING;
...
('199','Tiên Yên','Tien Yen','Huyện Tiên Yên','Tien Yen District','tien_yen','22',7) ON CONFLICT (code) DO NOTHING;
...
('291','Nam Sách','Nam Sach','Huyện Nam Sách','Nam Sach District','nam_sach','30',7) ON CONFLICT (code) DO NOTHING;
...
('359','Vụ Bản','Vu Ban','Huyện Vụ Bản','Vu Ban District','vu_ban','36',7) ON CONFLICT (code) DO NOTHING;
...
('422','Con Cuông','Con Cuong','Huyện Con Cuông','Con Cuong District','con_cuong','40',7) ON CONFLICT (code) DO NOTHING;
...
('490','Liên Chiểu','Lien Chieu','Quận Liên Chiểu','Lien Chieu District','lien_chieu','48',5) ON CONFLICT (code) DO NOTHING;
...
('557','Sông Cầu','Song Cau','Thị xã Sông Cầu','Song Cau Town','song_cau','54',6) ON CONFLICT (code) DO NOTHING;
...
('628','Ia Grai','Ia Grai','Huyện Ia Grai','Ia Grai District','ia_grai','64',7) ON CONFLICT (code) DO NOTHING;
...
('694','Hớn Quản','Hon Quan','Huyện Hớn Quản','Hon Quan District','hon_quan','70',7) ON CONFLICT (code) DO NOTHING;
...
('771','10','10','Quận 10','District 10','10','79',5) ON CONFLICT (code) DO NOTHING;
...
('845','Cầu Kè','Cau Ke','Huyện Cầu Kè','Cau Ke District','cau_ke','84',7) ON CONFLICT (code) DO NOTHING;
...
('912','Kiên Hải','Kien Hai','Huyện Kiên Hải','Kien Hai District','kien_hai','91',7) ON CONFLICT (code) DO NOTHING;
...
('973','Ngọc Hiển','Ngoc Hien','Huyện Ngọc Hiển','Ngoc Hien District','ngoc_hien','96',7) ON CONFLICT (code) DO NOTHING;
...
('00148','Thạch Bàn','Thach Ban','Phường Thạch Bàn','Thach Ban Ward','thach_ban','004',8) ON CONFLICT (code) DO NOTHING;
...
('00319','Tân Mai','Tan Mai','Phường Tân Mai','Tan Mai Ward','tan_mai','008',8) ON CONFLICT (code) DO NOTHING;
...
('00475','Vân Hà','Van Ha','Xã Vân Hà','Van Ha Commune','van_ha','017',10) ON CONFLICT (code) DO NOTHING;
...
('00658','Tứ Hiệp','Tu Hiep','Xã Tứ Hiệp','Tu Hiep Commune','tu_hiep','020',10) ON CONFLICT (code) DO NOTHING;
...
('00769','Mèo Vạc','Meo Vac','Thị trấn Mèo Vạc','Meo Vac Township','meo_vac','027',9) ON CONFLICT (code) DO NOTHING;
...
('00709','Kim Linh','Kim Linh','Xã Kim Linh','Kim Linh Commune','kim_linh','030',10) ON CONFLICT (code) DO NOTHING;
...
('01066','Ngàm Đăng Vài','Ngam Dang Vai','Xã Ngàm Đăng Vài','Ngam Dang Vai Commune','ngam_dang_vai','032',10) ON CONFLICT (code) DO NOTHING;
...
('01222','Xuân Minh','Xuan Minh','Xã Xuân Minh','Xuan Minh Commune','xuan_minh','035',10) ON CONFLICT (code) DO NOTHING;
...
('01348','Hồng An','Hong An','Xã Hồng An','Hong An Commune','hong_an','043',10) ON CONFLICT (code) DO NOTHING;
...
('01537','Lý Quốc','Ly Quoc','Xã Lý Quốc','Ly Quoc Commune','ly_quoc','048',10) ON CONFLICT (code) DO NOTHING;
...
('01738','Ca Thành','Ca Thanh','Xã Ca Thành','Ca Thanh Commune','ca_thanh','052',10) ON CONFLICT (code) DO NOTHING;
...
('01906','Khang Ninh','Khang Ninh','Xã Khang Ninh','Khang Ninh Commune','khang_ninh','061',10) ON CONFLICT (code) DO NOTHING;
...
('02071','Nghĩa Tá','Nghia Ta','Xã Nghĩa Tá','Nghia Ta Commune','nghia_ta','064',10) ON CONFLICT (code) DO NOTHING;
...
('02233','Phúc Yên','Phuc Yen','Xã Phúc Yên','Phuc Yen Commune','phuc_yen','071',10) ON CONFLICT (code) DO NOTHING;
...
('02389','Minh Dân','Minh Dan','Xã Minh Dân','Minh Dan Commune','minh_dan','074',10) ON CONFLICT (code) DO NOTHING;
...
('02563','Cấp Tiến','Cap Tien','Xã Cấp Tiến','Cap Tien Commune','cap_tien','076',10) ON CONFLICT (code) DO NOTHING;
...
('02722','Dền Thàng','Den Thang','Xã Dền Thàng','Den Thang Commune','den_thang','082',10) ON CONFLICT (code) DO NOTHING;
...
('02893','Nậm Lúc','Nam Luc','Xã Nậm Lúc','Nam Luc Commune','nam_luc','085',10) ON CONFLICT (code) DO NOTHING;
...
('03055','Khánh Yên','Khanh Yen','Thị trấn Khánh Yên','Khanh Yen Township','khanh_yen','089',9) ON CONFLICT (code) DO NOTHING;
...
('03181','Mường Tùng','Muong Tung','Xã Mường Tùng','Muong Tung Commune','muong_tung','097',10) ON CONFLICT (code) DO NOTHING;
...
('03346','Thanh Yên','Thanh Yen','Xã Thanh Yên','Thanh Yen Commune','thanh_yen','100',10) ON CONFLICT (code) DO NOTHING;
...
('03199','Si Pa Phìn','Si Pa Phin','Xã Si Pa Phìn','Si Pa Phin Commune','si_pa_phin','103',10) ON CONFLICT (code) DO NOTHING;
...
('03529','Làng Mô','Lang Mo','Xã Làng Mô','Lang Mo Commune','lang_mo','108',10) ON CONFLICT (code) DO NOTHING;
...
('03474','Nậm Manh','Nam Manh','Xã Nậm Manh','Nam Manh Commune','nam_manh','112',10) ON CONFLICT (code) DO NOTHING;
...
('03781','Co Mạ','Co Ma','Xã Co Mạ','Co Ma Commune','co_ma','119',10) ON CONFLICT (code) DO NOTHING;
...
('03925','Tường Phù','Tuong Phu','Xã Tường Phù','Tuong Phu Commune','tuong_phu','122',10) ON CONFLICT (code) DO NOTHING;
...
('04111','Mường Bằng','Muong Bang','Xã Mường Bằng','Muong Bang Commune','muong_bang','125',10) ON CONFLICT (code) DO NOTHING;
...
('04018','Tô Múa','To Mua','Xã Tô Múa','To Mua Commune','to_mua','128',10) ON CONFLICT (code) DO NOTHING;
...
('04336','Tân Lĩnh','Tan Linh','Xã Tân Lĩnh','Tan Linh Commune','tan_linh','135',10) ON CONFLICT (code) DO NOTHING;
...
('04492','Púng Luông','Pung Luong','Xã Púng Luông','Pung Luong Commune','pung_luong','137',10) ON CONFLICT (code) DO NOTHING;
...
('04696','Tân Thịnh','Tan Thinh','Xã Tân Thịnh','Tan Thinh Commune','tan_thinh','140',10) ON CONFLICT (code) DO NOTHING;
...
('04840','Giáp Đắt','Giap Dat','Xã Giáp Đắt','Giap Dat Commune','giap_dat','150',10) ON CONFLICT (code) DO NOTHING;
...
('05116','Dũng Phong','Dung Phong','Xã Dũng Phong','Dung Phong Commune','dung_phong','154',10) ON CONFLICT (code) DO NOTHING;
...
('05323','Chí Đạo','Chi Dao','Xã Chí Đạo','Chi Dao Commune','chi_dao','157',10) ON CONFLICT (code) DO NOTHING;
...
('05491','Quyết Thắng','Quyet Thang','Xã Quyết Thắng','Quyet Thang Commune','quyet_thang','164',10) ON CONFLICT (code) DO NOTHING;
...
('05626','Ôn Lương','On Luong','Xã Ôn Lương','On Luong Commune','on_luong','168',10) ON CONFLICT (code) DO NOTHING;
...
('05800','Bản Ngoại','Ban Ngoai','Xã Bản Ngoại','Ban Ngoai Commune','ban_ngoai','171',10) ON CONFLICT (code) DO NOTHING;
...
('05959','Kha Sơn','Kha Son','Xã Kha Sơn','Kha Son Commune','kha_son','173',10) ON CONFLICT (code) DO NOTHING;
...
('06121','Tân Văn','Tan Van','Xã Tân Văn','Tan Van Commune','tan_van','181',10) ON CONFLICT (code) DO NOTHING;
...
('06298','Bình Phúc','Binh Phuc','Xã Bình Phúc','Binh Phuc Commune','binh_phuc','184',10) ON CONFLICT (code) DO NOTHING;
...
('06472','Vân Thủy','Van Thuy','Xã Vân Thủy','Van Thuy Commune','van_thuy','187',10) ON CONFLICT (code) DO NOTHING;
...
('06652','Hà Phong','Ha Phong','Phường Hà Phong','Ha Phong Ward','ha_phong','193',8) ON CONFLICT (code) DO NOTHING;
...
('06775','Cẩm Tây','Cam Tay','Phường Cẩm Tây','Cam Tay Ward','cam_tay','195',8) ON CONFLICT (code) DO NOTHING;
...
('06931','Quảng Thành','Quang Thanh','Xã Quảng Thành','Quang Thanh Commune','quang_thanh','201',10) ON CONFLICT (code) DO NOTHING;
...
('07147','Hiệp Hòa','Hiep Hoa','Xã Hiệp Hòa','Hiep Hoa Commune','hiep_hoa','206',10) ON CONFLICT (code) DO NOTHING;
...
('07747','Đồng Việt','Dong Viet','Xã Đồng Việt','Dong Viet Commune','dong_viet','213',10) ON CONFLICT (code) DO NOTHING;
...
('07417','Tân Hưng','Tan Hung','Xã Tân Hưng','Tan Hung Commune','tan_hung','217',10) ON CONFLICT (code) DO NOTHING;
...
('07615','An Châu','An Chau','Thị trấn An Châu','An Chau Township','an_chau','220',9) ON CONFLICT (code) DO NOTHING;
...
('07879','Đông Lỗ','Dong Lo','Xã Đông Lỗ','Dong Lo Commune','dong_lo','223',10) ON CONFLICT (code) DO NOTHING;
...
('08014','Hợp Nhất','Hop Nhat','Xã Hợp Nhất','Hop Nhat Commune','hop_nhat','230',10) ON CONFLICT (code) DO NOTHING;
...
('08242','Trị Quận','Tri Quan','Xã Trị Quận','Tri Quan Commune','tri_quan','233',10) ON CONFLICT (code) DO NOTHING;
...
('08467','Vạn Xuân','Van Xuan','Xã Vạn Xuân','Van Xuan Commune','van_xuan','236',10) ON CONFLICT (code) DO NOTHING;
...
('08686','Đồng Trung','Dong Trung','Xã Đồng Trung','Dong Trung Commune','dong_trung','239',10) ON CONFLICT (code) DO NOTHING;
...
('08833','Bàn Giản','Ban Gian','Xã Bàn Giản','Ban Gian Commune','ban_gian','246',10) ON CONFLICT (code) DO NOTHING;
...
('08998','Liên Mạc','Lien Mac','Xã Liên Mạc','Lien Mac Commune','lien_mac','250',10) ON CONFLICT (code) DO NOTHING;
...
('08809','Phương Khoan','Phuong Khoan','Xã Phương Khoan','Phuong Khoan Commune','phuong_khoan','253',10) ON CONFLICT (code) DO NOTHING;
...
('09289','Ngọc Xá','Ngoc Xa','Xã Ngọc Xá','Ngoc Xa Commune','ngoc_xa','259',10) ON CONFLICT (code) DO NOTHING;
...
('09445','Ninh Xá','Ninh Xa','Phường Ninh Xá','Ninh Xa Ward','ninh_xa','262',8) ON CONFLICT (code) DO NOTHING;
...
('09595','Viên Sơn','Vien Son','Phường Viên Sơn','Vien Son Ward','vien_son','269',8) ON CONFLICT (code) DO NOTHING;
...
('09769','Phụng Thượng','Phung Thuong','Xã Phụng Thượng','Phung Thuong Commune','phung_thuong','272',10) ON CONFLICT (code) DO NOTHING;
...
('09922','Phú Cát','Phu Cat','Xã Phú Cát','Phu Cat Commune','phu_cat','275',10) ON CONFLICT (code) DO NOTHING;
...
('10081','Hữu Văn','Huu Van','Xã Hữu Văn','Huu Van Commune','huu_van','277',10) ON CONFLICT (code) DO NOTHING;
...
('10249','Dũng Tiến','Dung Tien','Xã Dũng Tiến','Dung Tien Commune','dung_tien','279',10) ON CONFLICT (code) DO NOTHING;
...
('10444','Đồng Tâm','Dong Tam','Xã Đồng Tâm','Dong Tam Commune','dong_tam','282',10) ON CONFLICT (code) DO NOTHING;
...
('10567','Hoàng Tiến','Hoang Tien','Phường Hoàng Tiến','Hoang Tien Ward','hoang_tien','290',8) ON CONFLICT (code) DO NOTHING;
...
('10756','Lai Khê','Lai Khe','Xã Lai Khê','Lai Khe Commune','lai_khe','293',10) ON CONFLICT (code) DO NOTHING;
...
('10969','Thúc Kháng','Thuc Khang','Xã Thúc Kháng','Thuc Khang Commune','thuc_khang','296',10) ON CONFLICT (code) DO NOTHING;
...
('11197','Tân Phong','Tan Phong','Xã Tân Phong','Tan Phong Commune','tan_phong','299',10) ON CONFLICT (code) DO NOTHING;
...
('11407','Vĩnh Niệm','Vinh Niem','Phường Vĩnh Niệm','Vinh Niem Ward','vinh_niem','305',8) ON CONFLICT (code) DO NOTHING;
...
('11584','Lê Thiện','Le Thien','Phường Lê Thiện','Le Thien Ward','le_thien','312',8) ON CONFLICT (code) DO NOTHING;
...
('11782','Kiến Thiết','Kien Thiet','Xã Kiến Thiết','Kien Thiet Commune','kien_thiet','315',10) ON CONFLICT (code) DO NOTHING;
...
('11977','Phương Nam','Phuong Nam','Xã Phương Nam','Phuong Nam Commune','phuong_nam','323',10) ON CONFLICT (code) DO NOTHING;
...
('12130','Phùng Chí Kiên','Phung Chi Kien','Phường Phùng Chí Kiên','Phung Chi Kien Ward','phung_chi_kien','328',8) ON CONFLICT (code) DO NOTHING;
...
('12301','Song Mai','Song Mai','Xã Song Mai','Song Mai Commune','song_mai','331',10) ON CONFLICT (code) DO NOTHING;
...
('13225','Tân Bình','Tan Binh','Xã Tân Bình','Tan Binh Commune','tan_binh','336',10) ON CONFLICT (code) DO NOTHING;
...
('12634','Phúc Khánh','Phuc Khanh','Xã Phúc Khánh','Phuc Khanh Commune','phuc_khanh','339',10) ON CONFLICT (code) DO NOTHING;
...
('12826','Diêm Điền','Diem Dien','Thị trấn Diêm Điền','Diem Dien Township','diem_dien','341',9) ON CONFLICT (code) DO NOTHING;
...
('13027','Phương Công','Phuong Cong','Xã Phương Công','Phuong Cong Commune','phuong_cong','342',10) ON CONFLICT (code) DO NOTHING;
...
('13213','Song Lãng','Song Lang','Xã Song Lãng','Song Lang Commune','song_lang','344',10) ON CONFLICT (code) DO NOTHING;
...
('13369','Tiên Sơn','Tien Son','Xã Tiên Sơn','Tien Son Commune','tien_son','349',10) ON CONFLICT (code) DO NOTHING;
...
('13570','Nguyên Lý','Nguyen Ly','Xã Nguyên Lý','Nguyen Ly Commune','nguyen_ly','353',10) ON CONFLICT (code) DO NOTHING;
...
('13780','Kim Thái','Kim Thai','Xã Kim Thái','Kim Thai Commune','kim_thai','359',10) ON CONFLICT (code) DO NOTHING;
...
('13978','Nam Thắng','Nam Thang','Xã Nam Thắng','Nam Thang Commune','nam_thang','362',10) ON CONFLICT (code) DO NOTHING;
...
('14152','Quất Lâm','Quat Lam','Thị trấn Quất Lâm','Quat Lam Township','quat_lam','365',9) ON CONFLICT (code) DO NOTHING;
...
('14375','Tân Bình','Tan Binh','Phường Tân Bình','Tan Binh Ward','tan_binh','370',8) ON CONFLICT (code) DO NOTHING;
...
('14344','Ninh Khánh','Ninh Khanh','Phường Ninh Khánh','Ninh Khanh Ward','ninh_khanh','374',8) ON CONFLICT (code) DO NOTHING;
...
('14683','Kim Tân','Kim Tan','Xã Kim Tân','Kim Tan Commune','kim_tan','376',10) ON CONFLICT (code) DO NOTHING;
...
('16399','Đông Minh','Dong Minh','Xã Đông Minh','Dong Minh Commune','dong_minh','380',10) ON CONFLICT (code) DO NOTHING;
...
('14890','Phú Xuân','Phu Xuan','Xã Phú Xuân','Phu Xuan Commune','phu_xuan','385',10) ON CONFLICT (code) DO NOTHING;
...
('15058','Đồng Lương','Dong Luong','Xã Đồng Lương','Dong Luong Commune','dong_luong','388',10) ON CONFLICT (code) DO NOTHING;
...
('15226','Thành Yên','Thanh Yen','Xã Thành Yên','Thanh Yen Commune','thanh_yen','391',10) ON CONFLICT (code) DO NOTHING;
...
('15415','Yên Thọ','Yen Tho','Xã Yên Thọ','Yen Tho Commune','yen_tho','394',10) ON CONFLICT (code) DO NOTHING;
...
('15598','Trường Xuân','Truong Xuan','Xã Trường Xuân','Truong Xuan Commune','truong_xuan','395',10) ON CONFLICT (code) DO NOTHING;
...
('15775','Thiệu Ngọc','Thieu Ngoc','Xã Thiệu Ngọc','Thieu Ngoc Commune','thieu_ngoc','398',10) ON CONFLICT (code) DO NOTHING;
...
('15982','Hoằng Tân','Hoang Tan','Xã Hoằng Tân','Hoang Tan Commune','hoang_tan','399',10) ON CONFLICT (code) DO NOTHING;
...
('16162','Nga Thái','Nga Thai','Xã Nga Thái','Nga Thai Commune','nga_thai','401',10) ON CONFLICT (code) DO NOTHING;
...
('16333','Vạn Thắng','Van Thang','Xã Vạn Thắng','Van Thang Commune','van_thang','404',10) ON CONFLICT (code) DO NOTHING;
...
('16597','Hải Lĩnh','Hai Linh','Phường Hải Lĩnh','Hai Linh Ward','hai_linh','407',8) ON CONFLICT (code) DO NOTHING;
...
('17923','Nghi Đức','Nghi Duc','Phường Nghi Đức','Nghi Duc Ward','nghi_duc','412',8) ON CONFLICT (code) DO NOTHING;
...
('16852','Tà Cạ','Ta Ca','Xã Tà Cạ','Ta Ca Commune','ta_ca','417',10) ON CONFLICT (code) DO NOTHING;
...
('17050','Châu Thành','Chau Thanh','Xã Châu Thành','Chau Thanh Commune','chau_thanh','420',10) ON CONFLICT (code) DO NOTHING;
...
('17257','Yên Khê','Yen Khe','Xã Yên Khê','Yen Khe Commune','yen_khe','422',10) ON CONFLICT (code) DO NOTHING;
...
('17419','Hùng Hải','Hung Hai','Xã Hùng Hải','Hung Hai Commune','hung_hai','425',10) ON CONFLICT (code) DO NOTHING;
...
('17596','Viên Thành','Vien Thanh','Xã Viên Thành','Vien Thanh Commune','vien_thanh','426',10) ON CONFLICT (code) DO NOTHING;
...
('17758','Thanh Hương','Thanh Huong','Xã Thanh Hương','Thanh Huong Commune','thanh_huong','428',10) ON CONFLICT (code) DO NOTHING;
...
('17968','Thượng Tân Lộc','Thuong Tan Loc','Xã Thượng Tân Lộc','Thuong Tan Loc Commune','thuong_tan_loc','430',10) ON CONFLICT (code) DO NOTHING;
...
('18622','Thạch Lạc','Thach Lac','Xã Thạch Lạc','Thach Lac Commune','thach_lac','436',10) ON CONFLICT (code) DO NOTHING;
...
('18304','Đức Đồng','Duc Dong','Xã Đức Đồng','Duc Dong Commune','duc_dong','440',10) ON CONFLICT (code) DO NOTHING;
...
('18505','Hương Thủy','Huong Thuy','Xã Hương Thủy','Huong Thuy Commune','huong_thuy','444',10) ON CONFLICT (code) DO NOTHING;
...
('18721','Cẩm Lĩnh','Cam Linh','Xã Cẩm Lĩnh','Cam Linh Commune','cam_linh','446',10) ON CONFLICT (code) DO NOTHING;
...
('18880','Đức Ninh Đông','Duc Ninh Dong','Phường Đức Ninh Đông','Duc Ninh Dong Ward','duc_ninh_dong','450',8) ON CONFLICT (code) DO NOTHING;
...
('19045','Quảng Xuân','Quang Xuan','Xã Quảng Xuân','Quang Xuan Commune','quang_xuan','454',10) ON CONFLICT (code) DO NOTHING;
...
('19261','Thanh Thủy','Thanh Thuy','Xã Thanh Thủy','Thanh Thuy Commune','thanh_thuy','457',10) ON CONFLICT (code) DO NOTHING;
...
('19705','Hải Lệ','Hai Le','Xã Hải Lệ','Hai Le Commune','hai_le','462',10) ON CONFLICT (code) DO NOTHING;
...
('19537','Gio Sơn','Gio Son','Xã Gio Sơn','Gio Son Commune','gio_son','466',10) ON CONFLICT (code) DO NOTHING;
...
('19726','Hải Phong','Hai Phong','Xã Hải Phong','Hai Phong Commune','hai_phong','470',10) ON CONFLICT (code) DO NOTHING;
...
('19870','Quảng Thái','Quang Thai','Xã Quảng Thái','Quang Thai Commune','quang_thai','477',10) ON CONFLICT (code) DO NOTHING;
...
('20071','Sơn Thủy','Son Thuy','Xã Sơn Thủy','Son Thuy Commune','son_thuy','481',10) ON CONFLICT (code) DO NOTHING;
...
('20230','Thuận Phước','Thuan Phuoc','Phường Thuận Phước','Thuan Phuoc Ward','thuan_phuoc','492',8) ON CONFLICT (code) DO NOTHING;
...
('20407','Thanh Hà','Thanh Ha','Phường Thanh Hà','Thanh Ha Ward','thanh_ha','503',8) ON CONFLICT (code) DO NOTHING;
...
('20554','Điện Tiến','Dien Tien','Xã Điện Tiến','Dien Tien Commune','dien_tien','507',10) ON CONFLICT (code) DO NOTHING;
...
('20692','Quế Lâm','Que Lam','Xã Quế Lâm','Que Lam Commune','que_lam','509',10) ON CONFLICT (code) DO NOTHING;
...
('20839','Bình Hải','Binh Hai','Xã Bình Hải','Binh Hai Commune','binh_hai','513',10) ON CONFLICT (code) DO NOTHING;
...
('20986','Tam Hòa','Tam Hoa','Xã Tam Hòa','Tam Hoa Commune','tam_hoa','517',10) ON CONFLICT (code) DO NOTHING;
...
('21067','Bình Hải','Binh Hai','Xã Bình Hải','Binh Hai Commune','binh_hai','524',10) ON CONFLICT (code) DO NOTHING;
...
('21277','Nghĩa Trung','Nghia Trung','Xã Nghĩa Trung','Nghia Trung Commune','nghia_trung','528',10) ON CONFLICT (code) DO NOTHING;
...
('21421','Đức Thạnh','Duc Thanh','Xã Đức Thạnh','Duc Thanh Commune','duc_thanh','533',10) ON CONFLICT (code) DO NOTHING;
...
('21595','Ghềnh Ráng','Ghenh Rang','Phường Ghềnh Ráng','Ghenh Rang Ward','ghenh_rang','540',8) ON CONFLICT (code) DO NOTHING;
...
('21736','Mỹ Đức','My Duc','Xã Mỹ Đức','My Duc Commune','my_duc','545',10) ON CONFLICT (code) DO NOTHING;
...
('21880','Cát Hải','Cat Hai','Xã Cát Hải','Cat Hai Commune','cat_hai','548',10) ON CONFLICT (code) DO NOTHING;
...
('22036','7','7','Phường 7','Ward 7','7','555',8) ON CONFLICT (code) DO NOTHING;
...
('22177','Sơn Long','Son Long','Xã Sơn Long','Son Long Commune','son_long','560',10) ON CONFLICT (code) DO NOTHING;
...
('22327','Vĩnh Hòa','Vinh Hoa','Phường Vĩnh Hòa','Vinh Hoa Ward','vinh_hoa','568',8) ON CONFLICT (code) DO NOTHING;
...
('22708','Suối Cát','Suoi Cat','Xã Suối Cát','Suoi Cat Commune','suoi_cat','570',10) ON CONFLICT (code) DO NOTHING;
...
('22633','Giang Ly','Giang Ly','Xã Giang Ly','Giang Ly Commune','giang_ly','573',10) ON CONFLICT (code) DO NOTHING;
...
('22792','Phước Tiến','Phuoc Tien','Xã Phước Tiến','Phuoc Tien Commune','phuoc_tien','584',10) ON CONFLICT (code) DO NOTHING;
...
('22924','Phú Thủy','Phu Thuy','Phường Phú Thủy','Phu Thuy Ward','phu_thuy','593',8) ON CONFLICT (code) DO NOTHING;
...
('23059','Ma Lâm','Ma Lam','Thị trấn Ma Lâm','Ma Lam Township','ma_lam','597',9) ON CONFLICT (code) DO NOTHING;
...
('23215','Đức Tín','Duc Tin','Xã Đức Tín','Duc Tin Commune','duc_tin','600',10) ON CONFLICT (code) DO NOTHING;
...
('23374','Đắk Môn','Dak Mon','Xã Đắk Môn','Dak Mon Commune','dak_mon','610',10) ON CONFLICT (code) DO NOTHING;
...
('23542','Sa Nghĩa','Sa Nghia','Xã Sa Nghĩa','Sa Nghia Commune','sa_nghia','616',10) ON CONFLICT (code) DO NOTHING;
...
('23635','Thành An','Thanh An','Xã Thành An','Thanh An Commune','thanh_an','623',10) ON CONFLICT (code) DO NOTHING;
...
('23755','Nghĩa Hòa','Nghia Hoa','Xã Nghĩa Hòa','Nghia Hoa Commune','nghia_hoa','627',10) ON CONFLICT (code) DO NOTHING;
...
('23881','Ia Pnôn','Ia Pnon','Xã Ia Pnôn','Ia Pnon Commune','ia_pnon','631',10) ON CONFLICT (code) DO NOTHING;
...
('24028','Ia Tul','Ia Tul','Xã Ia Tul','Ia Tul Commune','ia_tul','635',10) ON CONFLICT (code) DO NOTHING;
...
('24163','Ea Tu','Ea Tu','Xã Ea Tu','Ea Tu Commune','ea_tu','643',10) ON CONFLICT (code) DO NOTHING;
...
('24265','Ea Kiết','Ea Kiet','Xã Ea Kiết','Ea Kiet Commune','ea_kiet','648',10) ON CONFLICT (code) DO NOTHING;
...
('24418','Ea Pil','Ea Pil','Xã Ea Pil','Ea Pil Commune','ea_pil','652',10) ON CONFLICT (code) DO NOTHING;
...
('24586','Bông Krang','Bong Krang','Xã Bông Krang','Bong Krang Commune','bong_krang','656',10) ON CONFLICT (code) DO NOTHING;
...
('24688','Đắk Mâm','Dak Mam','Thị trấn Đắk Mâm','Dak Mam Township','dak_mam','664',9) ON CONFLICT (code) DO NOTHING;
...
('24805','Xuân Thọ','Xuan Tho','Xã Xuân Thọ','Xuan Tho Commune','xuan_tho','672',10) ON CONFLICT (code) DO NOTHING;
...
('24943','Ka Đô','Ka Do','Xã Ka Đô','Ka Do Commune','ka_do','677',10) ON CONFLICT (code) DO NOTHING;
...
('25090','Lộc Thành','Loc Thanh','Xã Lộc Thành','Loc Thanh Commune','loc_thanh','680',10) ON CONFLICT (code) DO NOTHING;
...
('25222','Bù Gia Mập','Bu Gia Map','Xã Bù Gia Mập','Bu Gia Map Commune','bu_gia_map','691',10) ON CONFLICT (code) DO NOTHING;
...
('25381','Tân Lập','Tan Lap','Xã Tân Lập','Tan Lap Commune','tan_lap','695',10) ON CONFLICT (code) DO NOTHING;
...
('25486','Tân Biên','Tan Bien','Thị trấn Tân Biên','Tan Bien Township','tan_bien','705',9) ON CONFLICT (code) DO NOTHING;
...
('25636','Long Thành Bắc','Long Thanh Bac','Phường Long Thành Bắc','Long Thanh Bac Ward','long_thanh_bac','709',8) ON CONFLICT (code) DO NOTHING;
...
('25822','Lai Uyên','Lai Uyen','Thị trấn Lai Uyên','Lai Uyen Township','lai_uyen','719',9) ON CONFLICT (code) DO NOTHING;
...
('25948','Tân Đông Hiệp','Tan Dong Hiep','Phường Tân Đông Hiệp','Tan Dong Hiep Ward','tan_dong_hiep','724',8) ON CONFLICT (code) DO NOTHING;
...
('26077','Xuân Bình','Xuan Binh','Phường Xuân Bình','Xuan Binh Ward','xuan_binh','732',8) ON CONFLICT (code) DO NOTHING;
...
('26239','Túc Trưng','Tuc Trung','Xã Túc Trưng','Tuc Trung Commune','tuc_trung','736',10) ON CONFLICT (code) DO NOTHING;
...
('26401','Cẩm Đường','Cam Duong','Xã Cẩm Đường','Cam Duong Commune','cam_duong','740',10) ON CONFLICT (code) DO NOTHING;
...
('26545','Long Sơn','Long Son','Xã Long Sơn','Long Son Commune','long_son','747',10) ON CONFLICT (code) DO NOTHING;
...
('26698','Láng Dài','Lang Dai','Xã Láng Dài','Lang Dai Commune','lang_dai','753',10) ON CONFLICT (code) DO NOTHING;
...
('26923','5','5','Phường 5','Ward 5','5','765',8) ON CONFLICT (code) DO NOTHING;
...
('26812','Hiệp Bình Chánh','Hiep Binh Chanh','Phường Hiệp Bình Chánh','Hiep Binh Chanh Ward','hiep_binh_chanh','769',8) ON CONFLICT (code) DO NOTHING;
...
('27211','5','5','Phường 5','Ward 5','5','772',8) ON CONFLICT (code) DO NOTHING;
...
('27439','Bình Hưng Hoà A','Binh Hung Hoa A','Phường Bình Hưng Hoà A','Binh Hung Hoa A Ward','binh_hung_hoa_a','777',8) ON CONFLICT (code) DO NOTHING;
...
('27586','Trung Chánh','Trung Chanh','Xã Trung Chánh','Trung Chanh Commune','trung_chanh','784',10) ON CONFLICT (code) DO NOTHING;
...
('27799','Bình Tân','Binh Tan','Xã Bình Tân','Binh Tan Commune','binh_tan','795',10) ON CONFLICT (code) DO NOTHING;
...
('27877','Thạnh Phú','Thanh Phu','Xã Thạnh Phú','Thanh Phu Commune','thanh_phu','800',10) ON CONFLICT (code) DO NOTHING;
...
('28033','Nhựt Chánh','Nhut Chanh','Xã Nhựt Chánh','Nhut Chanh Commune','nhut_chanh','803',10) ON CONFLICT (code) DO NOTHING;
...
('28192','Phước Vĩnh Tây','Phuoc Vinh Tay','Xã Phước Vĩnh Tây','Phuoc Vinh Tay Commune','phuoc_vinh_tay','807',10) ON CONFLICT (code) DO NOTHING;
...
('28453','Mỹ Hạnh Trung','My Hanh Trung','Xã Mỹ Hạnh Trung','My Hanh Trung Commune','my_hanh_trung','817',10) ON CONFLICT (code) DO NOTHING;
...
('28465','Phú Nhuận','Phu Nhuan','Xã Phú Nhuận','Phu Nhuan Commune','phu_nhuan','820',10) ON CONFLICT (code) DO NOTHING;
...
('28645','Hòa Định','Hoa Dinh','Xã Hòa Định','Hoa Dinh Commune','hoa_dinh','822',10) ON CONFLICT (code) DO NOTHING;
...
('28819','Phú Túc','Phu Tuc','Xã Phú Túc','Phu Tuc Commune','phu_tuc','831',10) ON CONFLICT (code) DO NOTHING;
...
('29017','Bình Hoà','Binh Hoa','Xã Bình Hoà','Binh Hoa Commune','binh_hoa','834',10) ON CONFLICT (code) DO NOTHING;
...
('29176','An Hòa Tây','An Hoa Tay','Xã An Hòa Tây','An Hoa Tay Commune','an_hoa_tay','836',10) ON CONFLICT (code) DO NOTHING;
...
('29293','Đại Phúc','Dai Phuc','Xã Đại Phúc','Dai Phuc Commune','dai_phuc','844',10) ON CONFLICT (code) DO NOTHING;
...
('29440','Thuận Hòa','Thuan Hoa','Xã Thuận Hòa','Thuan Hoa Commune','thuan_hoa','848',10) ON CONFLICT (code) DO NOTHING;
...
('29596','Phước Hậu','Phuoc Hau','Xã Phước Hậu','Phuoc Hau Commune','phuoc_hau','857',10) ON CONFLICT (code) DO NOTHING;
...
('29749','Tân Phú','Tan Phu','Xã Tân Phú','Tan Phu Commune','tan_phu','860',10) ON CONFLICT (code) DO NOTHING;
...
('29902','3','3','Phường 3','Ward 3','3','867',8) ON CONFLICT (code) DO NOTHING;
...
('30046','Trường Xuân','Truong Xuan','Xã Trường Xuân','Truong Xuan Commune','truong_xuan','872',10) ON CONFLICT (code) DO NOTHING;
...
('30196','Định An','Dinh An','Xã Định An','Dinh An Commune','dinh_an','875',10) ON CONFLICT (code) DO NOTHING;
...
('30343','Khánh Bình','Khanh Binh','Xã Khánh Bình','Khanh Binh Commune','khanh_binh','886',10) ON CONFLICT (code) DO NOTHING;
...
('30487','Bình Mỹ','Binh My','Xã Bình Mỹ','Binh My Commune','binh_my','889',10) ON CONFLICT (code) DO NOTHING;
...
('30637','Mỹ Hội Đông','My Hoi Dong','Xã Mỹ Hội Đông','My Hoi Dong Commune','my_hoi_dong','893',10) ON CONFLICT (code) DO NOTHING;
...
('30787','Kiên Lương','Kien Luong','Thị trấn Kiên Lương','Kien Luong Township','kien_luong','902',9) ON CONFLICT (code) DO NOTHING;
...
('30922','Bàn Tân Định','Ban Tan Dinh','Xã Bàn Tân Định','Ban Tan Dinh Commune','ban_tan_dinh','906',10) ON CONFLICT (code) DO NOTHING;
...
('31075','Vĩnh Phong','Vinh Phong','Xã Vĩnh Phong','Vinh Phong Commune','vinh_phong','910',10) ON CONFLICT (code) DO NOTHING;
...
('31192','Hưng Thạnh','Hung Thanh','Phường Hưng Thạnh','Hung Thanh Ward','hung_thanh','919',8) ON CONFLICT (code) DO NOTHING;
...
('31288','Định Môn','Dinh Mon','Xã Định Môn','Dinh Mon Commune','dinh_mon','927',10) ON CONFLICT (code) DO NOTHING;
...
('31433','Búng Tàu','Bung Tau','Thị trấn Búng Tàu','Bung Tau Township','bung_tau','934',9) ON CONFLICT (code) DO NOTHING;
...
('31537','Phong Nẫm','Phong Nam','Xã Phong Nẫm','Phong Nam Commune','phong_nam','943',10) ON CONFLICT (code) DO NOTHING;
...
('31735','2','2','Phường 2','Ward 2','2','948',8) ON CONFLICT (code) DO NOTHING;
...
('31849','Ninh Quới A','Ninh Quoi A','Xã Ninh Quới A','Ninh Quoi A Commune','ninh_quoi_a','956',10) ON CONFLICT (code) DO NOTHING;
...
('31933','Vĩnh Mỹ A','Vinh My A','Xã Vĩnh Mỹ A','Vinh My A Commune','vinh_my_a','961',10) ON CONFLICT (code) DO NOTHING;
...
('32125','Phong Lạc','Phong Lac','Xã Phong Lạc','Phong Lac Commune','phong_lac','968',10) ON CONFLICT (code) DO NOTHING;
...
('32245','Tân Ân','Tan An','Xã Tân Ân','Tan An Commune','tan_an','973',10) ON CONFLICT (code) DO NOTHING;

INSERT INTO wards(code,name,name_en,full_name,full_name_en,code_name,district_code,administrative_unit_id) VALUES
('32248','Đất Mũi','Dat Mui','Xã Đất Mũi','Dat Mui Commune','dat_mui','973',10) ON CONFLICT (code) DO NOTHING;
